...
namespace CommandQuery.AspNet.WebApi.Tests
{
    ...
    public class FakeResultCommandHandler : ICommandHandler<FakeResultCommand, FakeResult>
    {
        ...
        public async Task<FakeResult> HandleAsync(FakeResultCommand command)
        {
    ...
    public class BrokenCommandHandler : ICommandHandler<BrokenCommand>
    {
        ...
        public async Task HandleAsync(BrokenCommand command)
        {
            await Task.CompletedTask;
        }
    }
    ...
    public class BrokenQueryHandler : IQueryHandler<BrokenQuery, object>
    {
        ...
        public async Task<object> HandleAsync(BrokenQuery query)
        {
