...
:: dotnet test .\samples\CommandQuery.Sample.AspNet.WebApi.Tests\CommandQuery.Sample.AspNet.WebApi.Tests.csproj
dotnet test .\samples\CommandQuery.Sample.AspNetCore.V2.Tests\CommandQuery.Sample.AspNetCore.V2.Tests.csproj
dotnet test .\samples\CommandQuery.Sample.AspNetCore.V3.Tests\CommandQuery.Sample.AspNetCore.V3.Tests.csproj
...
dotnet test .\samples\CommandQuery.Sample.AzureFunctions.Vs3.Tests\CommandQuery.Sample.AzureFunctions.Vs3.Tests.csproj
