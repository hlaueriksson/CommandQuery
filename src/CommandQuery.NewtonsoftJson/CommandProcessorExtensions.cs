...
namespace CommandQuery.NewtonsoftJson
{
    ...
    public static class CommandProcessorExtensions
    {
        ...
        public static async Task<CommandResult> ProcessAsync(this ICommandProcessor commandProcessor, string commandName, string? json, JsonSerializerSettings? settings = null)
        {
